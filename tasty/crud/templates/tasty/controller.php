...
echo "        \$this->createWidget('GridView', array('id' => '" . lcfirst($this->modelClass) . "-grid', 'dataProvider' => \$dataProvider));\n";
echo "        if (!Yii::app()->request->isAjaxRequest && !empty(\$_GET['" . $this->modelClass . "']) &&  \$dataProvider->itemCount == 1)\n";
...
echo "\n";
echo "        //\$this->performAjaxValidation(\$" . lcfirst($this->modelClass) . ", '" . $this->controller . "-form');\n";
